({
    ...
    setCustomerID: function(component, event, helper) {
        var customerID = event.getParam("ContactID");
         debugger;
        alert('customerID'+customerID)
        component.set("v.contact.Id",customerID);
        component.set("v.ContactID",customerID);
        
         alert(component.get('v.contact.Id'));
         alert(component.get('v.contact.OtherStreet'));
